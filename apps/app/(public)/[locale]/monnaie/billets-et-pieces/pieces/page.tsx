...
import { piecesContent } from "@/lib/content/monnaie/pieces-content";
import { localizeArticle } from "@/lib/monnaie-localize";
import { ThemeArticle } from "@/components/public/content/theme-page";

const PAGE_PATH = "/monnaie/billets-et-pieces/pieces";
const PAGE_NAMESPACE = "pages.monnaie.sub.pieces";
...
export default async function PiecesPage({ params }: PageProps) {
  ...
  return <ThemeArticle content={localizeArticle(piecesContent, t, tRelated)} currentHref={PAGE_PATH} />;
}
